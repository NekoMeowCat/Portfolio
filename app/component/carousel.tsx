export default function CarouselItem() {
  ...
  "slidesQty": 1
    ...
    >
      ...
      <div className="hs-carousel-info inline-flex justify-center px-4 absolute bottom-10 md:bottom-1 start-[50%] -translate-x-[50%] bg-slate-800 rounded-lg text-white">
